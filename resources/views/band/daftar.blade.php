                ...
                <div class="card-body">
                    ...
                    <form method="post" action="/band/store" enctype="multipart/form-data">
                     ...
                     <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nama_band" type="text" class="form-control @error('nama_band') is-invalid @enderror" name="nama_band"  required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="deskripsi" type="text" class="form-control @error('deskripsi') is-invalid @enderror" name="deskripsi" required >
