                       ...
                       <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <select name="alatmusik" id="alatmusik">
                                <option value="gitar" {{$user->alatmusik == "gitar" ? 'selected' : ''}} > gitar </option>
                                <option value="penis" {{$user->alatmusik == "penis" ? 'selected' : ''}}> penis</option>
                            </select>
                                @error('alatmusik')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group row">
                            ...
                            <select name="genre" id="genre">
                                <option value="rock" {{$user->genre == "rock" ? 'selected' : ''}}> rock </option>
                                <option value="koplo" {{$user->genre == "koplo" ? 'selected' : ''}}> koplo</option>
                            </select>
                                @error('genre')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
